    ...
    <div>
      <div className="text-center">
        ...
        <p className="text-gray-400 mt-2 mb-8">
          You just minted your NFt! It's yours and you can verify it on the
          blockchain.
        </p>
        <img className="m-auto mb-8" src="/frame.svg" alt="nft" />
        <p className="text-gray-400 mt-2 mb-8">
          In the future, owning your newfrenz NFT will give you access to
          specific sections of this website and to a community. Stay tuned!
        </p>
        {accountData?.address ? (
          <a
