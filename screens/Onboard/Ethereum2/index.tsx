    ...
    <div>
      <div>
        <p className="text-sm mb-6 text-gray-300">
          ETH is a cryptocurrency. It is scarce digital money that you can use
          on the internet – similar to Bitcoin. If you’re new to crypto, here's
        ...
        <ul className="mt-4 text-sm text-gray-300">
          ...
          <li className="mb-4">
            <div>
              ...
              <p>
                ...
                cryptography. This protects your wallet, your ETH, and your
                transactions.
              </p>
            </div>
          </li>
          ...
          <li className="mb-4">
            <div>
              ...
              <p>
                ETH is divisible up to 18 decimal places so you don't have to
                buy 1 whole ETH. You can buy fractions at a time – as little as
